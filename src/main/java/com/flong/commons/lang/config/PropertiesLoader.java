...
public class PropertiesLoader {
	...
	public static void main(String[] args) {
		...
		String [] rs=new String []{"prop/config.properties","prop/application.properties"};
		Properties loadProperties =pro.loadProperties(rs);
		String property = loadProperties.getProperty("video_convert_url");
